...
{ 22, new ChampionOption("寒冰射手", 22, "艾希", "寒冰") },
{ 23, new ChampionOption("蛮族之王", 23, "泰达米尔", "蛮王") },
{ 24, new ChampionOption("武器大师", 24, "贾克斯", "") },
{ 25, new ChampionOption("堕落天使", 25, "莫甘娜", "") },
{ 26, new ChampionOption("时光守护者", 26, "基兰", "时光") },
...
{ 32, new ChampionOption("殇之木乃伊", 32, "阿木木", "") },
{ 33, new ChampionOption("披甲龙龟", 33, "拉莫斯", "龙龟") },
{ 34, new ChampionOption("冰晶凤凰", 34, "艾尼维亚", "冰鸟") },
{ 35, new ChampionOption("恶魔小丑", 35, "萨科", "小丑") },
{ 36, new ChampionOption("祖安狂人", 36, "蒙多医生", "蒙多") },
{ 37, new ChampionOption("琴瑟仙女", 37, "娑娜", "琴女") },
{ 38, new ChampionOption("虚空行者", 38, "卡萨丁", "") },
{ 39, new ChampionOption("刀锋舞者", 39, "艾瑞莉娅", "刀妹") },
{ 40, new ChampionOption("风暴之怒", 40, "迦娜", "风女") },
...
{ 67, new ChampionOption("暗夜猎手", 67, "薇恩", "VN") },
{ 68, new ChampionOption("机械公敌", 68, "兰博", "") },
{ 69, new ChampionOption("魔蛇之拥", 69, "卡西奥佩娅", "蛇女") },
{ 72, new ChampionOption("上古领主", 72, "斯卡纳", "蝎子") },
{ 74, new ChampionOption("大发明家", 74, "黑默丁格", "大头") },
{ 75, new ChampionOption("沙漠死神", 75, "内瑟斯", "狗头") },
{ 76, new ChampionOption("狂野女猎手", 76, "奈德丽", "豹女") },
{ 77, new ChampionOption("兽灵行者", 77, "乌迪尔", "") },
{ 78, new ChampionOption("圣锤之毅", 78, "波比", "") },
{ 79, new ChampionOption("酒桶", 79, "古拉加斯", "") },
{ 80, new ChampionOption("不屈之枪", 80, "潘森", "") },
{ 81, new ChampionOption("探险家", 81, "伊泽瑞尔", "EZ") },
{ 82, new ChampionOption("铁铠冥魂", 82, "莫德凯撒", "铁男") },
{ 83, new ChampionOption("牧魂人", 83, "约里克", "掘墓") },
{ 84, new ChampionOption("离群之刺", 84, "阿卡丽", "") },
{ 85, new ChampionOption("狂暴之心", 85, "凯南", "") },
{ 86, new ChampionOption("德玛西亚之力", 86, "盖伦", "") },
{ 89, new ChampionOption("曙光女神", 89, "蕾欧娜", "日女") },
{ 90, new ChampionOption("虚空先知", 90, "玛尔扎哈", "蚂蚱") },
{ 91, new ChampionOption("刀锋之影", 91, "泰隆", "男刀") },
{ 92, new ChampionOption("放逐之刃", 92, "锐雯", "") },
{ 96, new ChampionOption("深渊巨口", 96, "克格莫", "大嘴") },
{ 98, new ChampionOption("暮光之眼", 98, "慎", "") },
{ 99, new ChampionOption("光辉女郎", 99, "拉克丝", "光辉") },
{ 101, new ChampionOption("远古巫灵", 101, "泽拉斯", "泽三炮") },
...
{ 106, new ChampionOption("不灭狂雷", 106, "沃利贝尔", "狗熊") },
{ 107, new ChampionOption("傲之追猎者", 107, "雷恩加尔", "狮子狗") },
{ 110, new ChampionOption("惩戒之箭", 110, "韦鲁斯", "") },
...
{ 238, new ChampionOption("影流之主", 238, "劫", "儿童劫") },
{ 240, new ChampionOption("暴怒骑士", 240, "克烈", "骑蜥蜴的") },
{ 245, new ChampionOption("时间刺客", 245, "艾克", "") },
{ 246, new ChampionOption("元素女皇", 246, "奇亚娜", "圈女") },
{ 254, new ChampionOption("皮城执法官", 254, "蔚", "拳女") },
{ 266, new ChampionOption("暗裔剑魔", 266, "亚托克斯", "剑魔") },
{ 267, new ChampionOption("唤潮鲛姬", 267, "娜美", "美人鱼") },
{ 268, new ChampionOption("沙漠皇帝", 268, "阿兹尔", "沙皇") },
{ 350, new ChampionOption("魔法猫咪", 350, "悠米", "猫") },
{ 360, new ChampionOption("沙漠玫瑰", 360, "莎弥拉", "") },
{ 412, new ChampionOption("魂锁典狱长", 412, "锤石", "") },
{ 420, new ChampionOption("海兽祭司", 420, "俄洛伊", "触手妈") },
{ 421, new ChampionOption("虚空遁地兽", 421, "雷克塞", "挖掘机") },
{ 427, new ChampionOption("翠神", 427, "艾翁", "") },
{ 429, new ChampionOption("复仇之矛", 429, "卡莉丝塔", "滑板鞋") },
{ 432, new ChampionOption("星界游神", 432, "巴德", "") },
{ 497, new ChampionOption("幻翎", 497, "洛", "") },
{ 498, new ChampionOption("逆羽", 498, "霞", "") },
{ 516, new ChampionOption("山隐之焰", 516, "奥恩", "羊") },
{ 517, new ChampionOption("解脱者", 517, "塞拉斯", "偷男") },
{ 518, new ChampionOption("万花通灵", 518, "妮蔻", "变脸怪") },
{ 523, new ChampionOption("残月之肃", 523, "厄斐琉斯", "月男") },
{ 526, new ChampionOption("镕铁少女", 526, "芮尔", "铁女") },
